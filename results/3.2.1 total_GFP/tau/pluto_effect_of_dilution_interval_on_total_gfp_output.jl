...
# ╔═╡ e81938b3-e278-4383-9bf5-aa6c219ceb7e
using PlutoUI, Plots, DifferentialEquations

# ╔═╡ 2166a5c4-1863-11f0-2c9d-7d60ca1baaba
md"# Effect of dilution interval on total GFP output"

# ╔═╡ 204ca5f7-3ce2-45d6-965d-97f8773879d5
md"ODE setup and dilution function:"

# ╔═╡ b107a689-c501-4892-97a0-207004064080
begin
...
# ╔═╡ cd714db8-ad1a-480d-a359-68e5923de0a1
md"Set initial conditions:"

# ╔═╡ a8f0284c-f6b1-436e-ae84-d9665eb4c5bf
initial_conditions = [33600, 0.005, 0.0, 0.0, 0.0, 0.0, 1.51]

# ╔═╡ 05c67d4d-b119-48a6-8fab-277bcfdd9cee
...
# ╔═╡ 9bc480a6-8ee9-4931-a7ff-ade129e8177a
md"Tau slider:"
...
begin
	...
	params = vcat(params_base, [f_V, tau, s1, s2, tmax, tsave, nspecies])
	...
	t = sol.t
	G = [u[5] for u in sol.u]  # GFP concentration
	Gm = [u[6] for u in sol.u] # Mature GFP

	plot(t ./ 60, Gm, xlabel="Time (hours)", ylabel="GFP_mature (µM)", 
