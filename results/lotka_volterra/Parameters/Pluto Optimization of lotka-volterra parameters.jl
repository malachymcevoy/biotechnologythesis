...
# ╔═╡ 220364e4-9892-4795-926a-653e163e262f
using PlutoUI, Plots, DifferentialEquations, Optim

# ╔═╡ 5d77024e-fa71-11ef-371d-617d47c10e13
md"# Optimisation of Lotka-Volterra parameters"

# ╔═╡ 6dc10ae3-15fa-43a4-ac37-e55dea32e6c3
...
# ╔═╡ f6b84d3f-f047-47e2-b806-27af0e31ab16
function f(s,r)
	α = s[1]
	β, γ, δ = r[1:3]
	x0 = r[4]
	...
	prob = ODEProblem(lotka_volterra, s0, tspan, [α, β, γ, δ])
	sol = solve(prob)
...
# ╔═╡ 8e6350e5-cbf6-41b2-a586-24984435622a
begin
	r = [1, 3, 1, 5, 5]
	s0 = [1]
	lb = [0.25]
...
# ╔═╡ d0271801-a33c-44b8-9d6b-992566344962
opt_func = OptimizationFunction(f, AutoZygote())

# ╔═╡ c9c9f9d7-cf45-4872-a903-0b54dd579d6d
opt_prob = OptimizationProblem(opt_func, s0, r, lb=lb, ub=ub)

# ╔═╡ aa107c05-2697-4a82-9ad8-5b97aae12267
sol = solve(opt_prob, BFGS())

# ╔═╡ 97a34631-cfda-4b32-b733-8f6534d442be
...
manifest_format = "2.0"
project_hash = "88f8c94961053892ed456b766fa69f9af73b3679"
